...
@5
D=A
// save return addr to D (lcl - 5)
@LCL
A=M-D
D=M
// save return addr to R13
@R13
M=D
// save return value to *arg
// pop()
@SP
AM=M-1
D=M
...
@SP
M=D+1
// restore saved segs THAT THIS ARG LCL
// THAT
@LCL
D=M
@R14
...
// D: return addr
// R13: nArgs
// R14: called funcName entry address
// push return addr (D)
@SP
A=M
M=D
...
@R13
M=D
// called funcName entry address (R14)
@sys.init
D=A
@R14
M=D
...
// bug, A has been changed because of @addr
@addr
M=A
